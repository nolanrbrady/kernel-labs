...
test("editor-first screen renders starter code with run/submit and account CTA", () => {
  ...
  assert.equal(markup.includes("flag-problem-button"), true)
  assert.equal(markup.includes("flag-problem-reason"), true)
  assert.equal(markup.includes("flag-problem-notes"), true)
  assert.equal(markup.includes("flag-problem-status"), true)
