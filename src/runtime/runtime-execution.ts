...
} from "../problems/runtime-problem-fixtures.js"
...
export function runUserCodeAgainstFixture(options: {
  problemId: string
  userCode: string
  fixture: RuntimeProblemFixture
}): RuntimeRunResult {
  const problemId = options.problemId.trim()
...
export function runStarterCodeAgainstToyInputs(
  ...
  return runUserCodeAgainstFixture({
    problemId,
    userCode,
    fixture
  })
