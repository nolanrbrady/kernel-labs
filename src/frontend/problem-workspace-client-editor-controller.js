...
class EditorController {
    ...
    bind() {
        ...
        if (this.codeEditorShell &&
            ...
            this.codeEditorShell.addEventListener("mousedown", this.focusEditorFromShellClick.bind(this));
        }
    ...
    handleEditorTabIndent(event) {
        ...
        var selectionStart = typeof this.codeEditor.selectionStart === "number"
            ? this.codeEditor.selectionStart
            : currentValue.length;
        var selectionEnd = typeof this.codeEditor.selectionEnd === "number"
